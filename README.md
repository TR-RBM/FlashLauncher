...
## Features
- Store and switch between multiple DCUO user accounts  
- Launch the game faster using saved credentials
- Lightweight, simple, and easy to use
---

## Requirements
- [.NET Desktop Runtime](https://dotnet.microsoft.com/download/dotnet/8.0) **Version 8.0**
- The official DCUO game client must be **installed and updated** using the official DCUO launcher  
- The game should be **installed in its default directory**  
- A **valid DCUO account** is required to play  
